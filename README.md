...
npx skills add csark0812/toolbox --skill council code-review grill second-opinion probe tdd prototype domain-model handoff -g --agent cursor claude-code codex -y
```
