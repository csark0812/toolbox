...
- Prompt-only blindness is **not** cryptographic isolation; updated slice materials may encode prior conclusions without quoting earlier reviews.
...
**Does not transfer:** M=2 as universal constant for all slice complexity — user may raise M on high-stakes invariants.
