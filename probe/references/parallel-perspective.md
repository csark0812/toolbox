...
Synthesis plan: preserve conflicts per council + adversarial synthesis. Tag convergent/divergent. Each stance tries to kill the opposing hypo (ACH-lite). Verdict per investigate schema if evidence allows
```
