...
Structural checks in plans → **second-opinion** ([second-opinion.md](../../second-opinion/references/second-opinion.md)). Product scope → skim Tier 1 in **product-principles** before locking feature scope or behavior.
