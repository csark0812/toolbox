...
| **Targeted specialists** | User asks for a named lens **or** primary logs unresolved domain after direct inspection                               | `subagents` + carve-out; cap **3** matched specialists; primary validates before filing          |
