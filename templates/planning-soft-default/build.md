...
- What is explicitly out of scope — what can someone reasonably assume is included but is not?

### Gaps batch (always ask)

- Are there phases this needs that are not obvious from the description?
- What part of this can be harder or more involved than it looks?
...
- What is the correct behavior after the fix?
...
After the first question batch, evaluate whether a mode shift helps:

| Signal                                                              | Action                                                                             |
| ------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| Idea is still vague or contradictory                                | "This can benefit from a quick **grill** intent-phase pass — want to shift there?" |
| Assumptions in the description are questionable                     | "Some of these assumptions are worth a **grill** pass — want to run that?"         |
...
| Specific doubt about a code path or structure                       | Optional: "Want **probe** to test that hunch with evidence first?"                 |
...
Be specific. If something is unaddressed, name it. Do not only flag "blast radius can be an issue."
