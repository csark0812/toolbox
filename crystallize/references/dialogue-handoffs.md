...
source: .skeleton/references/dialogue-handoffs.md
...
| Fuzzy or overloaded domain term | **domain-modeling** — see `.skeleton/customize/crystallize.md` or `grill.md` |
...
| Reproducible broken behavior | **investigate** + consumer-local verify/testing (+ **debug** if needed) — see `.skeleton/customize/investigate.md` |
| Scope/thesis scoring | **product-principles** — see `.skeleton/customize/grill.md` or `investigate.md` |
