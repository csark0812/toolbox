...
| ------------------ | ------------------------------------- | --------------------------------------------------------------------------------------- |
| **second-opinion** | Med or deep (light = no spawn)        | [second-opinion-dispatch.md](references/second-opinion-dispatch.md)                     |
...
- Goal: coverage \| perspectives \| adversarial \| adversarial-med \| adversarial-deep
