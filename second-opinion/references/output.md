...
After the **selected depth** completes, end with this block only for the user:
...
**Lenses:** [invented kebab-case lenses · defend|no-defend]
...
**Artifact** is a disk path or a short title for an in-thread paste/draft. **Depth** and **Lenses** name what ran without dumping debate tags.
...
- Readiness survivors after defender rebuttal (when defender ran)
