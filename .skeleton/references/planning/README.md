...
Structural checks in plans → **second-opinion** ([second-opinion.md](../../second-opinion/references/second-opinion.md)). Product scope → consumer product evaluation before locking feature scope or behavior.
