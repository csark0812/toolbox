...
| Signal                                                              | Action                                                                                |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| Idea is still vague or contradictory                                | "This might benefit from a quick **grill** intent phase pass — want to shift there?"  |
...
| Specific doubt about a code path or structure                       | Optional: "Want explore + verdict.md to sanity-check that hunch with evidence first?" |
