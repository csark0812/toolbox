...
| [verify.md](verify.md)               | Three-axis completeness checklist (loaded when second-opinion invents a readiness/gaps `completeness` lens) | **second-opinion** (deep/med when ask supports)                                                  |
...
**Written plan review** → **second-opinion** skill ([plan-review.md](../../../../second-opinion/references/plan-review.md) · [second-opinion-dispatch.md](../../../../subagents/references/second-opinion-dispatch.md)). For readiness-shaped asks, suggest wording that invents `premises` + `completeness` lenses at **deep** — not a skill default.
...
| **second-opinion**         | Written artifact review (path or paste) — invent lenses; light = coordinator-only; med = 1+1; deep = multi-lens + defend                                                                                                                  |
