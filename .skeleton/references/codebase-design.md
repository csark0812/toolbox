...
Consumer projects may extend via customize; product-specific domain terms live in the project glossary, not here.
...
Do not load as always-on context — pointer only.
